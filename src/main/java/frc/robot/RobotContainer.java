...
import frc.robot.commands.GunItButton;
import frc.robot.commands.MondrianMadness;
...
public class RobotContainer {
  ...
  private Command m_gunIt = new GunItButton();
  ...
  private void configureButtonBindings() {
    ...
    Button controllerButtonA = new JoystickButton(m_controller, 6);
    controllerButtonA.whileHeld(m_gunIt);
